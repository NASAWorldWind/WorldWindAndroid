...
public class Ellipse extends AbstractShape {
    ...
    /**
     * Calculate the number of times to split the edges of the shape for geometry assembly. The returned value must
     * be a multiple of two or geometry will not be generated by {@link Ellipse#assembleGeometry(RenderContext)}.
     *
