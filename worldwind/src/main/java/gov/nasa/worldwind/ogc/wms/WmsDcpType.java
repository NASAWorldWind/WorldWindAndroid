...
/**
 * This class provides a representation of the DCPType element tag in a WMS capabilities document. This class approaches
 * modeling and parsing of the DCPType element different than other Wms* classes because of the multilevel tag nature of
 * the DCPType element. This class will search the a field map generated by the parsing processes instead of storing the
