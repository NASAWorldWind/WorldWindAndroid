...
public class GeneralGlobeActivity extends BasicGlobeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.crosshairs = findViewById(R.id.globe_crosshairs);
        this.overlay = findViewById(R.id.globe_status);
        this.crosshairs.setVisibility(View.VISIBLE);
        this.overlay.setVisibility(View.VISIBLE);
        this.latView = findViewById(R.id.lat_value);
        this.lonView = findViewById(R.id.lon_value);
        this.elevView = findViewById(R.id.elev_value);
        this.altView = findViewById(R.id.alt_value);
    ...
    protected String formatElevaton(double elevation) {
        return String.format(Locale.getDefault(), "Alt: %,.0f %s",
